---
title: "Exploratory data analysis - School Performance"
...
Our findings confirm that some action seems to have been taken under the legislation since 2007 as reflected in the 2010 class size data , and that most of the poor neighborhood / low performance schools have comparatively smaller class sizes .<br>
...
* Of all the factors analysed, only poverty ration seems to have the most significant impact on school performance - more than any other factor , including ethnic background. 
...
* NYC administration has tried to do its bit by reducing the class sizes to help students from impoverished background , but there is no clear evidence to show that smaller classes have helped improve the performance of low performance schools.<br>
